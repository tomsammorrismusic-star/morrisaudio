    ...
    <div className="bg-brand text-slate-700">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-20">
        <div className="relative z-10 w-full max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-yellow-400/10 border border-yellow-500/30 text-yellow-600 text-sm font-medium">
            <Mic size={14} />
            Available for hire&nbsp;
          </div>
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
            Capturing You
            <br />
            <span className="text-yellow-600">Great Audio</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center pt-2">
            <Link
              to="/contact"
              className="px-10 py-3 bg-yellow-400 hover:bg-yellow-600 text-slate-700 font-semibold rounded-3xl transition-colors text-lg bubble-hover"
            >
              Get In Touch
            </Link>
            <Link
              to="/showreel"
              className="px-10 py-3 border border-yellow-500 hover:border-yellow-500 text-slate-600 hover:text-slate-700 rounded-3xl transition-colors text-lg bubble-hover"
            >
              View My Work
            </Link>
          </div>
      ...
      <section className="py-0 -mt-12 lg:-mt-16">
        <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row gap-8 justify-center items-center flex-wrap">
          {stats.map((s) => (
            <div key={s.label} className="flex flex-col items-center justify-center px-6 py-6 rounded-3xl border border-yellow-500/30 hover:border-yellow-500/50 transition-colors bubble-hover">
              <p className="text-4xl font-bold text-yellow-600">{s.value}</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {services.map((svc) => (
              <div
                key={svc.title}
                className="p-8 rounded-3xl border border-yellow-500 hover:border-yellow-500/60 bg-gradient-to-br from-lime-700 to-lime-700 hover:from-emerald-700 hover:to-lime-700 transition-all duration-300 bubble-hover"
              >
                <svc.icon className="w-14 h-14 text-yellow-600 mb-8" />
      ...
      <section className="py-20 lg:py-28 px-4">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <Award className="w-12 h-12 lg:w-16 lg:h-16 text-yellow-600 mx-auto" />
          ...
          <div className="flex flex-col sm:flex-row gap-5 justify-center mb-8">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-10 py-3 bg-yellow-400 hover:bg-yellow-600 text-slate-700 font-semibold rounded-3xl transition-colors bubble-hover"
            >
              <Mail size={18} />
              Contact Me
            </Link>
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-10 py-3 border border-yellow-500 hover:border-yellow-500 text-slate-600 hover:text-slate-700 rounded-3xl transition-colors bubble-hover"
            >
              Email Directly
            </a>
          </div>
          <div className="flex justify-center gap-5">
            <a
              ...
              className="inline-flex items-center justify-center w-12 h-12 rounded-2xl border border-yellow-500 hover:border-yellow-500 text-slate-700 hover:text-yellow-500 transition-colors bubble-hover"

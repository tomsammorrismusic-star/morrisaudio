  ...
  return (
    <div className="bg-gray-950 text-gray-100">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-20">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(217,119,6,0.08)_0%,_transparent_70%)] pointer-events-none" />
        <div className="relative z-10 max-w-3xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-yellow-600/10 border border-yellow-600/30 text-yellow-400 text-sm font-medium">
            <Mic size={14} />
            Available for hire&nbsp;
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
            <Link
              to="/contact"
              className="px-8 py-3 bg-yellow-600 hover:bg-yellow-500 text-gray-950 font-bold rounded-xl transition-colors text-lg"
            >
              Get In Touch
            </Link>
            <Link
              to="/projects"
              className="px-8 py-3 border border-gray-700 hover:border-yellow-400 text-gray-300 hover:text-white rounded-xl transition-colors text-lg"
            >
              View My Work
            </Link>
          </div>
      ...
      <section className="border-y border-gray-800 py-10">
        <div className="max-w-5xl mx-auto px-4 flex flex-col sm:flex-row gap-6 justify-center items-center flex-wrap">
          {stats.map((s) => (
            <div key={s.label} className="flex flex-col items-center justify-center px-6 py-4 rounded-xl border border-gray-800 bg-gray-900/40 hover:border-yellow-400/30 transition-colors">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {services.map((svc) => (
              <div
                key={svc.title}
                className="p-8 rounded-3xl border border-gray-700 hover:border-yellow-400/60 bg-gradient-to-br from-gray-900/80 to-gray-950/80 hover:from-gray-900 hover:to-gray-900/90 transition-all duration-300"
              >
      ...
      <section className="py-20 px-4 border-t border-gray-800">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-yellow-600 hover:bg-yellow-500 text-gray-950 font-bold rounded-xl transition-colors"
            >
              <Mail size={18} />
              Contact Me
            </Link>
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-gray-700 hover:border-yellow-400 text-gray-300 hover:text-white rounded-xl transition-colors"
            >
              Email Directly
            </a>
          </div>

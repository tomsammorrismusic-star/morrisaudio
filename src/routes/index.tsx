    ...
    <div className="text-white" style={{ backgroundColor: '#2d2d2d' }}>
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-20">
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
            ...
            <Link
              to="/projects"
              className="px-8 py-3 border border-gray-600 hover:border-yellow-400 text-gray-300 hover:text-white rounded-xl transition-colors text-lg bubble-hover"
            >
              View My Work
            </Link>
          </div>
      ...
      <section className="border-y border-gray-700 py-10">
        <div className="max-w-5xl mx-auto px-4 flex flex-col sm:flex-row gap-6 justify-center items-center flex-wrap">
          {stats.map((s) => (
            <div key={s.label} className="flex flex-col items-center justify-center px-6 py-4 rounded-xl border border-gray-600 bg-gray-800 hover:border-yellow-400 transition-colors bubble-hover">
        ...
        <div className="max-w-2xl mx-auto text-center space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-gray-600 hover:border-yellow-400 text-gray-300 hover:text-white rounded-xl transition-colors bubble-hover"
            >
              Email Directly
            </a>
          </div>

    ...
    <div className="bg-white text-gray-900">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-20">
        ...
        <div className="relative z-10 max-w-3xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-yellow-700/10 border border-yellow-700/30 text-yellow-700 text-sm font-medium">
            <Mic size={14} />
            Available for hire&nbsp;
          </div>
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight">
            Capturing You
            <br />
            <span className="text-yellow-700">Great Audio</span>
          </h1>
      ...
      <section className="py-20 px-4 border-t border-gray-200">
        <div className="max-w-2xl mx-auto text-center space-y-6">
          <Award className="w-12 h-12 text-yellow-700 mx-auto" />

...
function Home() {
  return (
    <div className="bg-brand text-yellow-100">
      {/* Hero */}
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-20">
        <div className="relative z-10 w-full max-w-4xl mx-auto space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-lime-50/10 border border-lime-600/30 text-lime-700 text-sm font-medium">
            <Mic size={14} />
            Available for hire&nbsp;
          </div>
          ...
          <p className="text-lg md:text-xl text-red-300 max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="py-16 lg:py-24">
        <div className="max-w-6xl mx-auto px-4 mb-12">
          <div className="text-center">
            ...
            <p className="text-red-300 max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {services.map((svc) => (
              ...
              >
                ...
                <p className="text-red-200 text-base leading-relaxed">{svc.desc}</p>
              </div>
            ))}
          </div>
        </div>

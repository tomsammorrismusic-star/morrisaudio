    ...
    <div className="bg-brand text-white">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-20">
        <div className="relative z-10 w-full max-w-4xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2">
            <Link
              to="/contact"
              className="px-8 py-3 bg-yellow-400 hover:bg-emerald-600 text-white font-bold rounded-xl transition-colors text-lg bubble-hover"
            >
              Get In Touch
            </Link>
            <Link
              to="/showreel"
              className="px-8 py-3 border border-yellow-400 hover:border-yellow-400 text-gray-100 hover:text-white rounded-xl transition-colors text-lg bubble-hover"
            >
              View My Work
            </Link>
          </div>
      ...
      <section className="py-0 -mt-12 lg:-mt-16">
        <div className="max-w-6xl mx-auto px-4 flex flex-col sm:flex-row gap-6 justify-center items-center flex-wrap">
          {stats.map((s) => (
            <div key={s.label} className="flex flex-col items-center justify-center px-6 py-4 rounded-xl border border-yellow-400/30 hover:border-yellow-400/50 transition-colors bubble-hover">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {services.map((svc) => (
              <div
                key={svc.title}
                className="p-8 rounded-3xl border border-yellow-400 hover:border-yellow-400/60 bg-gradient-to-br from-yellow-500 to-yellow-500 hover:from-emerald-700 hover:to-yellow-500 transition-all duration-300 bubble-hover"
              >
      ...
      <section className="py-20 lg:py-28 px-4">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <Award className="w-12 h-12 lg:w-16 lg:h-16 text-yellow-400 mx-auto" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-yellow-400 hover:bg-emerald-600 text-white font-bold rounded-xl transition-colors bubble-hover"
            >
              <Mail size={18} />
              Contact Me
            </Link>
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-3 border border-yellow-400 hover:border-yellow-400 text-gray-100 hover:text-white rounded-xl transition-colors bubble-hover"
            >
              Email Directly
            </a>
          </div>
          <div className="flex justify-center gap-4">
            <a
              ...
              className="inline-flex items-center justify-center w-12 h-12 rounded-lg border border-yellow-400 hover:border-yellow-400 text-gray-300 hover:text-yellow-400 transition-colors bubble-hover"

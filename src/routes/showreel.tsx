  ...
  return (
    <div className="min-h-screen bg-brand text-slate-700">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-lime-700 rounded-2xl p-8 mb-16 border border-amber-700">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="bg-lime-700 rounded-2xl p-8 border border-amber-700">
          ...
          <div className="flex flex-col h-full">
            ...
            {!expandMoreWork && moreWorkVideos.length > 3 && (
              <button
                ...
                className="flex items-center justify-center gap-2 px-4 py-3 border border-amber-700 text-amber-900 hover:bg-amber-100/10 rounded-2xl transition-colors font-semibold text-sm mt-3"
              >
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        <div className="bg-lime-700 rounded-2xl p-8 text-center border border-amber-700">
          ...
          <a
            ...
            className="inline-block px-6 py-3 bg-amber-600 hover:bg-lime-600 text-slate-700 font-semibold rounded-2xl transition-colors mb-8"
          >
            Get in Touch
          </a>

      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {allProjects.map((project) => (
            <Card key={project._meta.path} className="flex flex-col bg-lime-700 border-gray-400 text-slate-700">
              <CardHeader>
                ...
                <div className="flex gap-3">
                  {project.liveUrl && (
                    <a
                      ...
                      className="inline-flex items-center gap-2 text-sm text-gray-600 hover:text-gray-600 transition-colors"
                    >

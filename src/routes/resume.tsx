...
function Resume() {
  return (
    <div className="min-h-screen bg-emerald-900 text-white p-8 lg:p-12">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        {/* Career Summary */}
        <Card className="bg-emerald-800 border-emerald-800 text-white">
          <CardHeader>
          ...
          <CardContent>
            ...
            <div className="mt-6">
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-emerald-700 hover:bg-emerald-600 text-white font-bold rounded-lg transition-colors text-sm"
              >
                <Mail size={16} />
                Email Me
              </a>
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6">
            {allJobs.map((job) => (
              <Card key={job.jobTitle} className="bg-emerald-800 border-emerald-800 text-white">
                <CardHeader>
                ...
                <CardContent>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {job.tags.map((tag) => (
                      <HoverCard key={tag}>
                        <HoverCardTrigger>
                          <Badge variant="outline" className="cursor-pointer border-emerald-700 text-gray-100 hover:border-emerald-700">
                            {tag}
                          </Badge>
                        </HoverCardTrigger>
                        <HoverCardContent className="w-64 bg-emerald-800 border-emerald-800 text-gray-800">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-6">
            {allEducations.map((education) => (
              <Card key={education.school} className="bg-emerald-800 border-emerald-800 text-white">
                <CardHeader>

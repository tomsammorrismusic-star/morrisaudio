        ...
        <nav className="hidden md:flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-slate-700">
            <a
              ...
              className="inline-flex items-center justify-center w-9 h-9 rounded-2xl border border-[#F8D83A] hover:border-[#F8D83A] text-slate-700 hover:text-[#E5CA38] transition-colors bubble-hover"

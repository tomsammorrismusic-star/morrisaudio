  ...
  return (
    <header className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-brand/80 backdrop-blur-md' : 'bg-transparent'}`}>
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between rounded-b-2xl">
        <Link to="/" className="flex items-center gap-3 font-semibold text-2xl md:text-3xl text-yellow-100 hover:text-lime-700 transition-colors tracking-tight">
        ...
        <nav className="hidden md:flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-lime-600">
            <a
        ...
        <button
          ...
          className="md:hidden p-2 text-red-300 hover:text-lime-700 transition-colors"
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <nav className="md:hidden border-t border-lime-600 bg-brand px-3 py-2 flex flex-col gap-2 max-h-[calc(100vh-64px)] overflow-y-auto">

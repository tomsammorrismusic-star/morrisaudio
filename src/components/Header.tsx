    ...
    <header className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-brand/80 backdrop-blur-md' : 'bg-transparent'}`}>
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between rounded-b-2xl">
        ...
        <nav className="hidden md:flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 pl-2 border-l border-emerald-500">
            <a
        ...
        <button
          ...
          className="md:hidden p-2 text-gray-300 hover:text-emerald-600 transition-colors"
      ...
      {/* Mobile menu */}
      {mobileOpen && (
        <nav className="md:hidden border-t border-emerald-500 bg-brand px-3 py-2 flex flex-col gap-2 max-h-[calc(100vh-64px)] overflow-y-auto">
          <div className="flex gap-1.5 flex-wrap">
            {navLinks.map((link) => (
              <Link
                ...
                className="flex-1 min-w-max inline-flex items-center justify-center gap-1 px-2 py-1.5 rounded border border-emerald-500 hover:border-emerald-500 text-gray-300 hover:text-emerald-600 transition-colors bubble-hover text-xs"
                activeProps={{ className: 'flex-1 min-w-max inline-flex items-center justify-center gap-1 px-2 py-1.5 rounded border border-emerald-500 text-emerald-600 transition-colors bubble-hover text-xs font-medium' }}
                title={link.label}
              >
          ...
          <div className="flex gap-1.5">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 inline-flex items-center justify-center px-2 py-1.5 rounded border border-emerald-500 hover:border-emerald-500 text-gray-300 hover:text-emerald-600 transition-colors bubble-hover"
              aria-label="Instagram"
            >
          ...
          <a
            href="mailto:tomsammorrismusic@gmail.com"
            className="px-3 py-1.5 bg-emerald-50 hover:bg-emerald-600 text-white font-semibold text-xs rounded transition-all duration-200 text-center bubble-hover"
          >
            Email
          </a>
        </nav>

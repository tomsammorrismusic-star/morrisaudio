        ...
        <nav className="hidden md:flex items-center gap-3">
          {navLinks.map((link) => (
            <div className="relative group">
              ...
              <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-slate-700 text-white text-xs rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-10">
                {link.label}
              </div>
            </div>
          ))}

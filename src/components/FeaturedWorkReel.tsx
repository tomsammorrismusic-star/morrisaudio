    ...
    >
      ...
      >
        ...
        {[...videos, ...videos].map((item, index) => (
          ...
          >
            <button
              className={`relative w-64 h-64 rounded-3xl bg-gradient-to-br ${CATEGORY_COLORS[item.category] ?? 'from-gray-300 to-gray-200'} border border-rose-300 flex flex-col items-center justify-center gap-2 cursor-pointer hover:border-purple-300 transition-all duration-500 ease-out group bubble-hover hover:shadow-2xl hover:scale-110`}

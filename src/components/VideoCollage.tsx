    ...
    <>
          ...
          {videoItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-12 h-12 rounded-full bg-brand/20 flex items-center justify-center relative z-10 group-hover:bg-rose-200/40 transition-all group-hover:scale-125">
      ...
      {selectedItem && (
        ...
        >
          <button
            onClick={() => setSelectedItem(null)}
            className="absolute top-8 right-8 p-3 text-slate-700 hover:text-teal-600 bg-black/60 hover:bg-black/80 rounded-full z-10 transition-all duration-300 bubble-hover"
            aria-label="Close"
          >
            <X size={28} />
          </button>

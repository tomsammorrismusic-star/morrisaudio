          ...
          {videoItems.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-12 h-12 rounded-full bg-brand/20 flex items-center justify-center relative z-10 group-hover:bg-yellow-400/40 transition-all group-hover:scale-125">

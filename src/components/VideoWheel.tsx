    ...
    <>
      <div className="relative w-full flex flex-col items-center gap-6">
        ...
        <button
          ...
          className="absolute left-0 top-1/2 -translate-y-1/2 p-3 text-gray-500 hover:text-yellow-700 disabled:opacity-30 disabled:cursor-not-allowed transition-colors z-10"
            ...
            {videoItems.map((item) => (
              <div key={item.id} className="flex-shrink-0 w-64">
                <button
                  ...
                  className="w-full h-56 rounded-xl bg-gradient-to-br from-gray-300 to-gray-200 border border-gray-400 flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-yellow-700/50 transition-colors shadow-xl group"
                >
        ...
        <button
          ...
          className="absolute right-0 top-1/2 -translate-y-1/2 p-3 text-gray-500 hover:text-yellow-700 disabled:opacity-30 disabled:cursor-not-allowed transition-colors z-10"
            ...
            <div className="p-8 bg-white">
              ...
              <div className="flex items-center justify-between gap-4">
                <button
                  ...
                  className="p-2 text-gray-600 hover:text-yellow-700 transition-colors"

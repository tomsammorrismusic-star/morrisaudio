            ...
            {[...videoItems, ...videoItems].map((item, index) => (
              <div key={`${item.id}-${index}`} className="flex-shrink-0 w-64 overflow-visible">
                <button
                  ...
                  className="w-full h-56 rounded-xl bg-gradient-to-br from-gray-300 to-gray-200 border border-gray-400 flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-emerald-700/50 transition-colors shadow-xl group bubble-hover"
                >
                  <div className={`w-full h-full rounded-xl bg-gradient-to-br ${CATEGORY_COLORS[item.category] ?? 'from-gray-300 to-gray-200'} border border-gray-400 flex flex-col items-center justify-center gap-3 cursor-pointer hover:border-emerald-700/50 transition-colors shadow-xl relative overflow-hidden`}>
            ...
            <div className="p-8 bg-white">
              ...
              <div className="flex items-center justify-between gap-4">
                <button
                  ...
                  className="p-2 text-gray-600 hover:text-emerald-700 transition-colors bubble-hover"
